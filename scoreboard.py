...
class Scoreboard:
    """ Una clase para registrar la informacion sobre puntuajes. """
    def __init__(self, ai_game):
        """ Inicializar el registro del puntuaje. """
    ...
    def prep_score(self):
        """ Cambiar el puntuaje a una imagen renderizada. """
    ...
    def show_score(self):
        """ Dibujar el puntuaje en la pantalla. """
    ...
    def prep_high_score(self):
        """ Cambiar el puntuaje alto a una imagen renderizada. """
    ...
    def check_high_score(self):
        """ Checar para ver si hay un nuevo puntuaje alto. """
